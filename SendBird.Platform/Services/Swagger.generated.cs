...
namespace SendBird.Platform.Services
{
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<ChannelList>(response_, headers_, cancellationToken).ConfigureAwait(false);
    ...
    public partial interface ISendBirdGroupChannelsService
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task FreezeAsync(string channel_url, FreezeChannelInput body);
        ...
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task FreezeAsync(string channel_url, FreezeChannelInput body, System.Threading.CancellationToken cancellationToken);
    
        /// <summary>Creates a channel metadata's items to store in a channel</summary>
        /// <param name="channel_url">The unique identifier for the channel</param>
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task CreateMetadataAsync(string channel_url, CreateMetadataInput body);
        ...
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task CreateMetadataAsync(string channel_url, CreateMetadataInput body, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class SendBirdGroupChannelsService : ISendBirdGroupChannelsService
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task FreezeAsync(string channel_url, FreezeChannelInput body)
        {
            return FreezeAsync(channel_url, body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task FreezeAsync(string channel_url, FreezeChannelInput body, System.Threading.CancellationToken cancellationToken)
        {
            if (channel_url == null)
                throw new System.ArgumentNullException("channel_url");
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("group_channels/{channel_url}/freeze");
            urlBuilder_.Replace("{channel_url}", System.Uri.EscapeDataString(ConvertToString(channel_url, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task CreateMetadataAsync(string channel_url, CreateMetadataInput body)
        {
            return CreateMetadataAsync(channel_url, body, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task CreateMetadataAsync(string channel_url, CreateMetadataInput body, System.Threading.CancellationToken cancellationToken)
        {
            if (channel_url == null)
                throw new System.ArgumentNullException("channel_url");
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("group_channels/{channel_url}/metadata");
            urlBuilder_.Replace("{channel_url}", System.Uri.EscapeDataString(ConvertToString(channel_url, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial interface ISendBirdUsersService
    {
        ...
        /// <summary>Retrieves the total number of the user�s currently unread messages.</summary>
        /// <param name="user_id">The unique identifier for the user</param>
        /// <param name="channel_urls">Comma seperated list of channel urls.</param>
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ChannelList> GetUserChannelAsync(string user_id, string channel_urls);
        ...
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ChannelList> GetUserChannelAsync(string user_id, string channel_urls, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class SendBirdUsersService : ISendBirdUsersService
    {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new SwaggerException("No user found", status_, responseText_, headers_, null);
                        }
                        else
                        if (status_ == 405)
                        {
        ...
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<ChannelList> GetUserChannelAsync(string user_id, string channel_urls)
        {
            return GetUserChannelAsync(user_id, channel_urls, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>Success</returns>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<ChannelList> GetUserChannelAsync(string user_id, string channel_urls, System.Threading.CancellationToken cancellationToken)
        {
            if (user_id == null)
                throw new System.ArgumentNullException("user_id");
    
            if (channel_urls == null)
                throw new System.ArgumentNullException("channel_urls");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("users/{user_id}/my_group_channels?");
            urlBuilder_.Replace("{user_id}", System.Uri.EscapeDataString(ConvertToString(user_id, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Append(System.Uri.EscapeDataString("channel_urls") + "=").Append(System.Uri.EscapeDataString(ConvertToString(channel_urls, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            urlBuilder_.Length--;
        ...
        public async System.Threading.Tasks.Task SetChannelNotificationPreferencesAsync(string user_id, string channel_url, ChannelNotificationPreferences body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append("users/{user_id}/push_preference/{channel_url}");
            urlBuilder_.Replace("{user_id}", System.Uri.EscapeDataString(ConvertToString(user_id, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{channel_url}", System.Uri.EscapeDataString(ConvertToString(channel_url, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial class Channel : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        private int? _unread_message_count;
        ...
        [Newtonsoft.Json.JsonProperty("unread_message_count", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public int? Unread_message_count
        {
            get { return _unread_message_count; }
            set
            {
                if (_unread_message_count != value)
                {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.9.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class UserUnreadMessageCount : System.ComponentModel.INotifyPropertyChanged
    {
        private long? _unread_count;
        ...
        public static UserUnreadMessageCount FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<UserUnreadMessageCount>(data);
        }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.9.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class FreezeChannelInput : System.ComponentModel.INotifyPropertyChanged
    {
        private bool? _freeze;
        ...
        public static FreezeChannelInput FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<FreezeChannelInput>(data);
        }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.9.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class CreateMetadataInput : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public static CreateMetadataInput FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CreateMetadataInput>(data);
        }
